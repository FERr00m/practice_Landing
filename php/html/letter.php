...
//Этот файл читается в emailHandler.php, а уже в нем читается $mail_settings из data.php

$path = "https://{$_SERVER['SERVER_NAME']}/handlers/html/img/";
$mail = $mail_settings['to_email'];
                            ...
                            <table width="280" cellpadding="0" cellspacing="0" border="0" align="left" class="devicewidth">
                                ...
                                <tr>
                                    <td valign="middle" width="270" style="padding: 10px 0 10px 20px;" class="logo">
                                        <div class="imgpop">
                                            <a href="#"><img width="60" height="60" src="<?=$path.'logo.jpg';?>" alt="logo" border="0" style="display:block; border:none; border-radius: 50%; outline:none; text-decoration:none;" st-image="edit" class="logo"></a>
                                        </div>
                                    </td>
                                </tr>
                                </tbody>
                        ...
                        <td>
                            <table width="540" align="center" cellspacing="0" cellpadding="0" border="0" class="devicewidthinner">
                                ...
                                <tr>
                                    <!-- start of image -->
                                    <td align="center">
                                        <a target="_blank" href="#"><img width="540" border="0" height="282" alt="" style="display:block; border:none; outline:none; text-decoration:none;" src="<?=$path.'minions.png';?>" class="bigimage"></a>
                                    </td>
                                </tr>
                                <!-- end of image -->
                                <!-- Spacing -->
